package com.paraamarsh.jobpost.config.oauth2;
...
public class OAuth2Properties {
    ...
    public static class WebClientConfiguration {
        ...
        private String secret = Constants.CHANGE_IT;
        /**
    ...
    public static class SignatureVerification {
         ...
         */
        private String publicKeyEndpointUri =Constants.HTTP_COLON_SLASH_UAA_SLASH_OAUTH_SLASH_TOKEN_KEY;
