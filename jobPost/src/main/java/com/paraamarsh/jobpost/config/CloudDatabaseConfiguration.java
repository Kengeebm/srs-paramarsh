...
@Configuration
@EnableMongoRepositories("com.paraamarsh.jobpost.repository")
...
public class CloudDatabaseConfiguration extends AbstractCloudConfig {
    ...
    public Mongobee mongobee(MongoDbFactory mongoDbFactory, MongoTemplate mongoTemplate, Cloud cloud) {
        ...
        if (matchingServiceInfos.size() != 1) {
            throw new CloudException(Constants.NO_UNIQUE_SERVICE_MATCHING_MONGODBEEFACTORY_FOUND_EXPECTED_1
        ...
        mongobee.setChangeLogsScanPackage(Constants.COM_PARAMARSH_JOBPOST_CONFIG_DBMIGRATIONS);
