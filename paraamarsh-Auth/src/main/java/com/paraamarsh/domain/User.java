...
public class User extends AbstractAuditingEntity implements Serializable {
	...
	public String toString() {
		return "User [id=" + id + ", login=" + login + ", password=" + password + ", firstName=" + firstName
				...
				+ ", reportingManagerEmail=" + reportingManagerEmail + ", activated=" + activated + ", langKey="
				+ langKey + ", imageUrl=" + imageUrl + ", activationKey=" + activationKey + ", resetKey=" + resetKey
				+ ", resetDate=" + resetDate + ", authorities=" + authorities + ", projectCode=" + projectCode + "]";
	}
