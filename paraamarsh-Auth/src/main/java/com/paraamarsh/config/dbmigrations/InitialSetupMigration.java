package com.paraamarsh.config.dbmigrations;
...
public class InitialSetupMigration {
    ...
    public void addAuthorities(MongoTemplate mongoTemplate) {
        ...
        adminAuthority.setName(AuthoritiesConstants.RECRUITERMANAGER);
        Authority userAuthority = new Authority();
        userAuthority.setName(AuthoritiesConstants.RECRUITER);
