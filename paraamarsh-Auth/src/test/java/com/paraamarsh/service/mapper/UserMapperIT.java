package com.paraamarsh.service.mapper;
...
public class UserMapperIT {
    ...
    public void userDTOsToUsersWithAuthoritiesStringShouldMapToUsersWithAuthoritiesDomain() {
        ...
        authoritiesAsString.add("RECRUITERMANAGER");
        ...
        assertThat(users.get(0).getAuthorities().iterator().next().getName()).isEqualTo("RECRUITERMANAGER");
    }
    ...
    public void userDTOToUserMapWithAuthoritiesStringShouldReturnUserWithAuthorities() {
        ...
        assertThat(user.getAuthorities().iterator().next().getName()).isEqualTo("RECRUITERMANAGER");
    }
